    ...
    return ( 
        <div id='points-wrapper'>
            ...
            <p className='points-rules'>2 Points for each dollar spent over $100</p>
                ...
                <span>{Math.floor(totalSpent) >= 100 ?  Math.floor(totalSpent) - 100 : 0} x 2 points = {Math.floor(totalSpent) >= 100 ? userPoints * 2 : 0} points</span>
            ...
            <p>{props.elm.name} has {finalPoints} points available !</p>
        </div>
     );
}
